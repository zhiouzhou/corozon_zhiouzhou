      ...
      <el-row :gutter="60">
        <el-col :span="12" :xl="8">
          ...
          <el-form
            ...
            label-width="auto"
          >
            <el-form-item label="应收类型：" prop="recordType">
              <el-select
        ...
        <el-col :span="12">
          ...
          >
            ...
            <el-form-item label="应收日期：" prop="arDate">
              <el-date-picker
                size="mini"
  ...
  methods: {
    ...
    addMot() {
      ...
      this.$refs.receivableInfo.validate(valid => {
        if (valid) {
          signHttp.addReceivable(receivableInfo, tenantId).then(data => {
            console.log(data);
            if (data.code == 0) {
              this.$message(`新增应收成功`);
              this.$router.back(-1);
